...
describe('Timezone', () => {
  ...
  describe('Timezone Comparisons', () => {
    ...
    test('timezone-aware comparisons', () => {
      const morning = waktos('2005-04-26T09:00:00.000Z', {
        timezone: 'Asia/Jakarta',
      });
      const evening = waktos('2005-04-26T15:00:00.000Z', {
        timezone: 'Asia/Jakarta',
      });
  ...
  describe('Practical Timezone Use Cases', () => {
    test('business hours check', () => {
      const workStart = waktos('2005-04-26T09:00:00.000Z', {
        timezone: 'Asia/Jakarta',
      });
      const workEnd = waktos('2005-04-26T17:00:00.000Z', {
        timezone: 'Asia/Jakarta',
      });
      const current = waktos('2005-04-26T14:30:00.000Z', {
        timezone: 'Asia/Jakarta',
      });
    ...
    test('meeting scheduling across timezones', () => {
      const meetingUTC = waktos('2005-04-26T14:00:00.000Z', {
        timezone: 'UTC',
      });
      const meetingJakarta = waktos('2005-04-26T14:00:00.000Z', {
        timezone: 'Asia/Jakarta',
      });
